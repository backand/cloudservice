(function (){
	...
	angular.module('backand')
	  .controller('DbModelController', ['$scope', '$state', 'AppsService',
	  									   '$location',
	  									   'NotificationService', 'ColumnsService',
	  									    'usSpinnerService',
	  									    '$rootScope',
	  									    '$stateParams', DbModelController]);
	  function DbModelController($scope, $state, AppsService, $location, NotificationService, ColumnsService,
	  									    usSpinnerService,
